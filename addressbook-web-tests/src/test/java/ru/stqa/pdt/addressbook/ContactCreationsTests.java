...
public class ContactCreationsTests {
  ...
  public void testContactCreation() {
    ...
    gotoContactPage();
    fillContactForm(new ContactData("Marina", "Viktorovna", "Arsitova", "AnchorFree", "155 Acalanes drive, apt.12", "650-768-45-66", "mary.arsitova@gmail.com", "Software Engineer"));
